...
@Component
public class CursoAsignadoClient {
    private static final Logger logger = LoggerFactory.getLogger(CursoAsignadoClient.class);
    private final DownstreamWebClient http;
    private static final String BASE_PATH = "/api/v1/curso-asignado";
    private static final String HEADER_POSTULANTE_ID = "X-Postulante-Id";
    public CursoAsignadoClient(
    ...
    public JsonNode misCursos(Long idPostulante) {
        logger.debug("GET {} idPostulante={}", BASE_PATH + "/"+idPostulante+"/mis-cursos", idPostulante);
        ...
        return http.get(
                BASE_PATH + "/{idPostulacion}/mis-cursos",
