...
public final class ApiPaths {
    ...
    public static final String INVITACION_TESTEO = APRENDIZAJE_POSTULACION_BASE + "/invitacion-testeo";

    public static final String EXAMEN_TESTEO = APRENDIZAJE_POSTULACION_BASE + "/examen-testeo";
